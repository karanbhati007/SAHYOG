...
import com.ksb.sahyog.fragments.About;
import com.ksb.sahyog.fragments.CoronaUpdates;
import com.ksb.sahyog.fragments.EmergencyDials;
import com.ksb.sahyog.fragments.HelpDesk;
import com.ksb.sahyog.fragments.Notifications;
import com.ksb.sahyog.fragments.User_Profile;
        ...
        actionView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(MainActivity.this,"Need help",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MainActivity.this,NeedHelp.class));
               // drawerLayout.closeDrawer(GravityCompat.START);  //  TODO to be done later
        ...
        ActionView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(MainActivity.this,"can help",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MainActivity.this,CanHelp.class));
              //  drawerLayout.closeDrawer(GravityCompat.START);  //  TODO to be done later
