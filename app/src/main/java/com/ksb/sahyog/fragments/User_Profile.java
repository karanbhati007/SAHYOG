...
import com.ksb.sahyog.activity.Login;
import com.ksb.sahyog.model.HelperUser;
import com.ksb.sahyog.model.UserProfModel;
...
import static com.ksb.sahyog.activity.MainActivity.reff;
...
public class User_Profile extends Fragment{
      ...
      /*  toolbar = (Toolbar) view.findViewById(R.id.toolbar);
        ...
        reff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                HelperUser user = dataSnapshot.getValue(HelperUser.class);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                UserProfModel user=dataSnapshot.getValue(UserProfModel.class);
  ...
  /*      storageReference.child(firebaseAuth.getUid()).child("Images").child("Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
    ...
    private void uploadToFirebase() {
        ...
        UserProfModel user=new UserProfModel(pname,pdob,gender,ploc,padd,pcity,ppin);
